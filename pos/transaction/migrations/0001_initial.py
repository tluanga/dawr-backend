# Generated by Django 3.0 on 2020-10-27 05:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase_order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='purchase_order_item', to='transaction.PurchaseOrder')),
            ],
        ),
        migrations.CreateModel(
            name='ProductStock',
